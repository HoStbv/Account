...
<form action="index.php" method="post" id="adminForm" class="form-validate" onsubmit="return isValid()"
    ...
    <input type="hidden" id="hostaccount_client_id" name="hostaccount_client_id" value="<?php echo $this->item->hostaccount_client_id; ?>" />
        ...
        <div class="span12">
            ...
            <div class="row">
                <div class="span4">
                    ...
                    <input type="text" name="firstname" id="firstname" value="<?php echo $this->item->companyname;?>" class="required"/>
                </div>
